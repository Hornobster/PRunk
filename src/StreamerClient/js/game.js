...
function setupGame(mapList) {
    ...
    var Q = window.Q = Quintus({development: true, dataPath: "http://192.99.145.177/PRunk/data/", imagePath: "http://192.99.145.177/PRunk/images/"}) // remove development option to enable asset caching
        .include('Sprites, Input, Scenes, 2D, UI, Touch, Anim')
